...
def create_mb2_ssd_lite(num_classes, width_mult):
    from vision.ssd.mobilenet_v2_ssd_lite import create_mobilenetv2_ssd_lite
    return create_mobilenetv2_ssd_lite(num_classes, width_mult=width_mult)
...
if __name__ == '__main__':
    ...
    if args.net == 'vgg16-ssd':
        ...
        def create_net(num):
            return create_mb2_ssd_lite(num, args.mb2_width_mult)
        config = mobilenetv1_ssd_config
    else:
    ...
    final_model_path = os.path.join(args.checkpoint_folder, f"{args.net}-Final.pth")
